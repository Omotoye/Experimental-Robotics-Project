...
if __name__ == "__main__":
    ...
    with Cluedo:
        ...
        KnowledgeManagement = smach.StateMachine(
            outcomes=["good hypothesis found", "no good hypothesis found"]
        )
        ...
        smach.StateMachine.add(
            ...
            KnowledgeManagement,
            transitions={
                "no good hypothesis found": "GoTo Room",
                "good hypothesis found": "GoTo Oracle",
            },
        )
